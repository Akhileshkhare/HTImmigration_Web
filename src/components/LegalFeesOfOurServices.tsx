...
const LegalFeesOfOurServices: React.FC = () => (
  <div className="bg-white min-h-screen text-left flex flex-col items-center py-10 px-4 pt-20">
    <div className="max-w-7xl w-full px-0 md:px-10">
      ...
      <div className="my-6">
        <a href="#" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#0097b2] text-white px-6 py-3 rounded shadow hover:bg-gray-700 font-semibold transition">Request a Free Evaluation</a>
      </div>
