  ...
  <div className="bg-white min-h-screen text-left flex flex-col items-center py-10 px-4 pt-20">
    <div className="max-w-7xl w-full px-0 md:px-10">
      <div className="flex flex-col md:flex-row items-center gap-8 mb-10">
        ...
        <div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-[#0097b2] mb-4 leading-tight">Why Choose Our Team</h1>
          <p className="text-[22px] text-gray-700 mb-4">Discover the 7 key reasons why HT Immigration Solutions is the trusted choice for employment-based immigration petitions in the U.S.</p>
        </div>
      </div>
     <div className="bg-gray-50 border-l-4 border-[#0097b2] p-6 rounded mb-8 shadow">
        ...
        <ol className="list-decimal pl-6 text-gray-800 space-y-4 text-[21px]">
          ...
          <li>
            <span className="font-bold text-[#0097b2]">Most Qualified Attorneys:</span> Our attorneys are graduates of top law schools, deeply familiar with immigration law, USCIS regulations, and the latest adjudication trends. You get the most professional and dedicated legal team on your side.
          </li>
          <li>
          ...
          <li>
            <span className="font-bold text-[#0097b2]">Transparent Record of Approvals:</span> We provide real, up-to-date USCIS approval notices on our website. With over 61,000 approvals, our record speaks for itself.
          </li>
          <li>
            <span className="font-bold text-[#0097b2]">Exclusive Focus on EB-2 NIW, EB-1A, and EB-1B:</span> We are laser-focused on these categories, ensuring the most effective and up-to-date strategies for your petition.
          </li>
          <li>
          ...
          <li>
            <span className="font-bold text-[#0097b2]">High Success Rate—Even for Challenging Cases:</span> Our high approval rate is due to our successful strategies and close attention to each case, not just by taking only the strongest cases.
          </li>
        </ol>
      </div>
